...
public function indexAction($page)
 {
   ...
   $nbPerPage = 5;
    ...
    // On récupére notre objet Paginator
    ...
    // On calcule le nombre total de pages gràce au count($listNews) qui retourne le nombre total d'annonces
...
public function addAction(Request $request)

  {
      ...
      // Sinon on déclenche une exception à Accés interdit 
...

  {
   ...
   $form = $this->createFormBuilder()->getForm();
    ...
    // Si la requéte est en GET, on affiche une page de confirmation avant de supprimer
